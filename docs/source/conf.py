...
autodoc_mock_imports = ["harp"]

# Add the module path to sys.path here.
# If the directory is relative to the documentation root,
# use os.path.abspath to make it absolute, like shown here.

# Point Sphinx at the src-layout package directory.
sys.path.insert(0, str(Path(__file__).resolve().parents[2] / "src"))

project = "data-conduit"
copyright = "2026, Keshavarzi Lab"
author = "Keshavarzi Lab"
try:
    full_version = get_version(project)
    # Splitting the release on '+' to remove the commit hash
    release = full_version.split('+', 1)[0]
except Exception:
    # if package is not installed, still allow local build
    ...
    "icon_links": [
        {
            ...
            "url": "https://github.com/Keshavarzi-lab/data-conduit",  # required
