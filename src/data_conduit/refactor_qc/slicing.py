...
from data_conduit import datastructures as _generic
from data_conduit.datastructures import TrialSpec
from data_conduit.refactor_qc.trial_spec import QC_TRIALS
...
def slice_pose_for_trial(
    ...
    '''
    return _generic.slice_stream_for_trial(
        pose,
        trial_row,
        segment=segment,
        spec=spec,
...
def slice_pose_per_trial(
    ...
    '''
    return _generic.slice_stream_per_trial(
        pose,
        trials,
        segment=segment,
        spec=spec,
