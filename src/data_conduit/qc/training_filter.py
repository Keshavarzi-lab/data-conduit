...
TRAINING_DETAIL: dict[str, list[tuple[int, str, int, bool]]] = {
    'FL_M01569519': [
        ...
        (5, '2026-04-29T170501Z', 11, True),
        (5, '2026-04-29T171313Z', 11, False),
        (5, '2026-04-29T172239Z', 11, False),
        (5, '2026-04-29T174637Z', 2, False),
        (6, '2026-05-11T125643Z', 16, False),
        (7, '2026-05-12T164637Z', 24, False),
    ],
    'FLR_M01569521': [
        (1, '2026-04-23T160907Z', 11, False),
        (2, '2026-04-25T190120Z', 11, False),   # day 2: COMBINE TWO SESSIONS
    ...
    'MbL_M01569517': [
        (1, '2026-05-12T113807Z', 24, False),
        (2, '2026-05-13T112324Z', 24, False),
        (3, '2026-05-14T112316Z', 24, False),
        (4, '2026-05-16T165921Z', 24, False),
        (5, '2026-05-17T144445Z', 24, False),
        (6, '2026-05-19T091455Z', 24, False),
        (7, '2026-05-20T112502Z', 24, False),
        (8, '2026-05-21T120827Z', 24, False),
        (9, '2026-05-22T150830Z', 24, False),
        (10, '2026-05-28T154840Z', 24, False),
        (11, '2026-05-29T155941Z', 24, False),
    ],
    # Block-protocol mice: keep 24-to-end AND drop the mid-session ON (cue) trials.
    'MR_M01569515': [
