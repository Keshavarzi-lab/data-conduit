...
TRAINING_DETAIL: dict[str, list[tuple[int, str, int, bool]]] = {
    'FL_M01569519': [
        (1, '2026-04-21T144313Z', 2, False),
        (2, '2026-04-23T151952Z', 11, False),
        (2, '2026-04-23T152710Z', 11, False),
        (2, '2026-04-23T153735Z', 6, False),
        (3, '2026-04-25T194933Z', 11, False),
        (3, '2026-04-25T200011Z', 11, False),
        (3, '2026-04-25T200705Z', 11, False),
        (3, '2026-04-25T201616Z', 11, False),
        (3, '2026-04-25T202109Z', 6, False),
        (4, '2026-04-28T172539Z', 21, False),
        (4, '2026-04-28T173816Z', 6, False),
        (4, '2026-04-28T174249Z', 6, False),
        (4, '2026-04-28T174922Z', 2, False),
        (5, '2026-05-11T125643Z', 16, False),
        (6, '2026-05-12T164637Z', 24, False),
        (7, '2026-05-13T161503Z', 24, False),
    ],
    'FLR_M01569521': [
        (1, '2026-04-23T160907Z', 11, False),
        (2, '2026-04-25T190120Z', 11, False),   # day 2: COMBINE TWO SESSIONS
    ...
    'MR_M01569515': [
        ...
        (5, '2026-05-17T163613Z', 24, True),
        (6, '2026-05-19T100644Z', 24, True),
        (7, '2026-05-20T094540Z', 24, True),
    ],
    'MbR_M01569518': [
        ...
        (5, '2026-04-29T113619Z', 4, True),
        (5, '2026-04-29T114758Z', 4, True),
        (5, '2026-04-29T115844Z', 4, True),
        (5, '2026-04-29T120528Z', 4, True),
        (6, '2026-05-12T132304Z', 24, True),
        (7, '2026-05-13T135855Z', 24, True),
        (8, '2026-05-14T135225Z', 24, True),
        (9, '2026-05-16T155926Z', 24, True),
        (10, '2026-05-17T154506Z', 24, True),
        (11, '2026-05-19T110125Z', 24, True),
        (12,'2026-05-20T102711Z', 24, True),
    ],
}
...
TRAINING_FIRST_MID_LAST_DETAIL: dict[str, list[tuple[int, str, int, bool]]] = {
    'FL_M01569519': [
        (1, '2026-04-21T144313Z', 2, False),    #D1
        (2, '2026-04-25T194933Z', 11, False),   #D3
        (2, '2026-04-25T200011Z', 11, False),
        (2, '2026-04-25T200705Z', 11, False),
        (2, '2026-04-25T201616Z', 11, False),
        (2, '2026-04-25T202109Z', 6, False),
        (3, '2026-05-14T165819Z', 24, False),   #D8
    ],
    'FLR_M01569521': [
        (1, '2026-04-23T160907Z', 11, False),   #D1
        # (2, '2026-04-25T190120Z', 11, False),   # day 2: COMBINE TWO SESSIONS
        # (2, '2026-04-25T190915Z', 11, False),
        (2, '2026-04-28T124013Z',  6, False),   # day 3: COMBINE TWO SESSIONS
        (2, '2026-04-28T124547Z', 11, False),
        # (4, '2026-04-29T161826Z', 11, False),
        (3, '2026-04-30T151438Z',  6, False),   #D5
    ],
    'FbR_M01569522': [
        (1, '2026-04-21T155201Z', 26, False),   # day 1: COMBINE TWO SESSIONS
        (1, '2026-04-21T162256Z',  6, False),
        # (2, '2026-04-23T165237Z', 11, False),
        (2, '2026-04-25T181535Z', 11, False),   # day 3: COMBINE TWO SESSIONS
    ...
    'MbL_M01569517': [
        (1, '2026-04-25T161723Z', 11, False),   #D1
        (1, '2026-04-25T163456Z', 11, False),  
        (2, '2026-04-28T104553Z', 11, False),   #D3
        (2, '2026-04-28T105504Z', 11, False),  
        (3, '2026-05-29T155941Z', 24, False),   #D18
    ],
    # Block-protocol mice: keep 24-to-end AND drop the mid-session ON (cue) trials.
    'MR_M01569515': [
        (1, '2026-05-12T150308Z', 24, True),
        (2, '2026-05-17T163613Z', 24, True),
        (3, '2026-06-21T093349Z', 24, True),
    ],
    'MbR_M01569518': [
        (1, '2026-04-25T144913Z', 11, True),
        (1, '2026-04-25T150252Z', 11, True),
