...
# ===============================================================================
def _apply_global_selector(results: xr.DataArray = None, dim_name: str = None, selector: any = None, verbose: bool = False) -> xr.DataArray:
    """
...
def _apply_virtual_selector(results: xr.DataArray = None, coord_name: str = None, selector: any = None, lookup_array: xr.DataArray = None, verbose: bool = False) -> xr.DataArray:
    """
...
def ulookup(
    lookup_array: xr.DataArray = None,  # noqa
    ...
    **selectors,
    ...
    for coord_name, selector_value in sel.items():
        ...
        if coord_name == global_coord_name:
            results = _apply_global_selector(results=results, dim_name=global_coord_name, selector=selector_value, verbose=verbose)

        # == Selection on virtual coordinate dimensions
        elif coord_name in results.coords:
            results = _apply_virtual_selector(results=results, coord_name=coord_name, selector=selector_value, lookup_array=lookup_array, verbose=verbose)
