...
from data_conduit._refactor_template.core.io import collect_dfs
from data_conduit._refactor_template.core.utils import starts_with
...
def construct_device_reader(
    ...
    try:
        ...
        raise ImportError(
            "HARP support requires harp-python. Install with: "
            "pip install data-conduit[harp]"
        ) from e
