...
from data_conduit._refactor_template.datasources.monosource.monosource_core import _obtain_dfs_dict
from data_conduit._refactor_template.core.timestamps import collect_timestamps_nested
from data_conduit._refactor_template.core.virtualarrays import (
...
def construct_data_outputs(
    ...
    if data_key not in virtual_maps:
        raise KeyError(
            ...
            f'Available: {list(virtual_maps.keys())}'
        )
